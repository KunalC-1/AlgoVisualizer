...
let alldiv = document.getElementsByClassName(".box");
...
export function dijkstra() {
  let grid = createGridMatrix();
  let startNode = document.getElementById("startBox");
  let finishNode = document.getElementById("endBox");
